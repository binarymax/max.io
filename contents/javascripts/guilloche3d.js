...
var Guilloche3d = (function(){
	...
	var sine = geobuffer(
			function(rr,rp,rrr,theta,zoom) { return theta; },
			function(rr,rp,rrr,theta,zoom) { return Math.sin(theta); },
			function(rr,rp,rrr,theta,zoom) { return 400 }
		);

		sine.shader = 
			"theta*zoom*2.0,"+
			"sin(theta+rrr*10.0)*zoom*2.0,"+
			"800.0";		
